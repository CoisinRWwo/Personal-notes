...
![image-20221024191142451](SpringMVC.assets/image-20221024191142451.png)
...
```xml
<!--  扫描控制层组件  -->
    <context:component-scan base-package="com.shf"></context:component-scan>
...
![image-20221024195037004](SpringMVC.assets/image-20221024195037004.png)
...
![image-20221024195104921](SpringMVC.assets/image-20221024195104921.png)
...
![image-20221024195127134](SpringMVC.assets/image-20221024195127134.png)
...
![image-20221024195249017](SpringMVC.assets/image-20221024195249017.png)
...
![image-20221024195529564](SpringMVC.assets/image-20221024195529564.png)
...
```java
    ...
    public User testResponseBodyJson() {
        User user = new User("admin", "123456", 23);
        return user;
    }
```
...
```html
<input type="button" value="使用@ResponseBody注解处理json格式的数据" @click="testResponseBody()"><br>
```

```javascript
testResponseBody(){
              axios.post("/spring_mvc/test/ResponseBody/json")
                  .then(response=>{
                      console.log(response.data)
                  })
            }
...
@RequestMapping("/test/down")
    public ResponseEntity<byte[]> testResponseEntity(HttpSession session) throws IOException {
        ...
        realPath = realPath + File.separator + "315891896.png";
        //创建输入流
...
![image-20221106212707416](SpringMVC.assets/image-20221106212707416.png)
...
![image-20221106213027999](SpringMVC.assets/image-20221106213027999.png)

​		iii. 如果有配置，则访问目标资源（一般为静态资源，如：JS,CSS,HTML），找不到客户端也会展示404 错误

![image-20221106213057416](SpringMVC.assets/image-20221106213057416.png)
